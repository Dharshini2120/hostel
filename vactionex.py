...
pp="""select * from vacation where Student_Name='%s' """%(name)
b.execute(pp)
rec=b.fetchall()
...
if sub!=None:
    qq="""Update vacation set Status='Deleted' where id='%s' """%(De)
    b.execute(qq)
    a.commit()
    print("""<script>alert('Your Vacation has been Deleted Successfully');</script>""")
