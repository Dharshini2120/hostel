...
v="SELECT COUNT(*) FROM warden WHERE status='Unblocked' OR status='Blocked'"
b.execute(v)
total_records = b.fetchone()[0]
total_pages = math.ceil(total_records / records_per_page)
query = """SELECT * FROM warden WHERE status='Unblocked' OR status='Blocked' LIMIT %s OFFSET %s"""
...
<ul class="dropdown">Warden      <span class="dropdown-toggle"></span>
  ...
  <ul  id="w"><span class="fa fa-hand-o-left"></span> <a href="home.py">Logout</a></ul></nav>
   <div class="col-lg-9" style="margin-left:20px; margin-top:40px;"> 
    <h1 style="font-family:Times New Roman; text-align:center; color:black; text-shadow: 2px 3px 5px  black; font-weight:500;">Warden Details</h1>
        ...
        <div class="modal-content custom-modal"> 
          ...
          <p><img class="rounded-circle shadow" style="margin-left:180px;" width="70px" height="70px" src="./media/%s"></p>
            ...
            <div class="modal-footer">
                ...
                """%(i[0],i[10],i[14],i[15],i[2],i[3],i[6],i[7],i[8],i[9],i[11],i[12],i[0]))
            h += 1
    if l == 'Unblocked':
        print("""
                    <tbody>
