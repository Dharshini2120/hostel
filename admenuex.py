...
<ul class="dropdown">Warden      <span class="dropdown-toggle"></span>
  ...
  """)
v="""select * from food_plan where Status='Updated' or Status='New' """
b.execute(v)
re=b.fetchall()
for i in re:
    print("""
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-6">
                        ...
                        <p style="margin-top:19px;"><strong>Breakfast</strong>
                    ...
                    <p>%s</p>
                        ...
                        <p><input type="text" name="lu"  class="form-control" value="%s"></p>
                         <p><input type="text" name="sn" class="form-control" value="%s"></p>
                         <p><input type="text" name="di"  class="form-control" value="%s"></p>
...
d=reg.getvalue("d")
if sub!=None:
    v=""" UPDATE food_plan SET breakfast='%s',lunch='%s',snacks='%s',dinner='%s',Status='Updated' WHERE id='%s' """%(bf,lu,sn,di,d)
    b.execute(v)
    a.commit()
    print("""<script>alert('Menu Updated Successfully!');
    location.href="admenuex.py";</script>""")

su=reg.getvalue("su")
kk=reg.getvalue("kk")
if su!=None:
    s="""Update food_plan set Status='Deleted' where id='%s' """%(kk)
    b.execute(s)
    a.commit()
    print("""<script>alert('Menu Deleted Successfully!');
=======
#!C:/Users/Dell/AppData/Local/Programs/Python/Python311/python.exe
print("content-type:text/html \r\n\r\n")
import cgitb, pymysql,cgi
