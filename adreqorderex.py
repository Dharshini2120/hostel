...
v = "SELECT COUNT(*) FROM request where Status='Accepted' or  Status='Rejected' "
b.execute(v)
total_records = b.fetchone()[0]
total_pages = math.ceil(total_records / records_per_page)
query = """SELECT * FROM request where Status='Accepted' or  Status='Rejected' LIMIT %s OFFSET %s"""
