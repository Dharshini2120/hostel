...
for k in r:
    name=k[2]
s = """select * from book where Status='Paid' and Student_Name='%s' """%(name)
b.execute(s)
rec = b.fetchall()
print("""<!DOCTYPE html>
<html lang="en">
...
print("""
 <div class="col-lg-9" style="margin-left:20px; margin-top:40px;"> 
    <h1 style="font-family:Times New Roman; text-align:center; color:black; text-shadow: 2px 3px 5px  black; font-weight:500;">Allocated Room</h1>
...
for i in rec:
    ...
    print("""
                ...
                """ % (h, i[1], i[2], i[11], i[10],fdate,i[13]))
    h += 1
