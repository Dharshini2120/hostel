...
<nav class="navbar navbar-expand-lg-none navbar-dark bg-dark fixed-top">
  ...
  <ul class="dropdown"> Student <span class="dropdown-toggle"></span>
       <li  class="dropdown-item" id="s"> <a href="adsex.py">New</a></li>
        <li  class="dropdown-item" id="s"> <a href="adrb.py">Booked</a></li>
...
for i in rec:
    ...
    if qaa == 'Requested':
        ...
        <td>%s</td>
                                            <td>%s</td>
                                           <td style="color:blue; font-weight:700; font-size:18px;"> %s</td>
                                           </tr>

                                """ % (h, i[1],jd, i[2], i[4], i[8], i[9], i[10]))
        h += 1
    if qaa == 'Approved':
        print("""
                                    <tbody>
        ...
        <td>%s</td>
                                            <td>%s</td>
                                           <td style="color:green; font-weight:700; font-size:18px;" ><span class="fa fa-check-circle"></span> %s</td>
                                           </tr>
